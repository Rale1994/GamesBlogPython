...
# ova metoda nam vraca trenutno ulogvanog korisnika preko query upita
...
class User(db.Model, UserMixin):
    ...
    posts = db.relationship('Post', backref='author', lazy='dynamic',
                            primaryjoin="(User.id == foreign(Post.user_id))")  # MAPIRANJE SPOLJNJEG KLJUCA TABELE POST SA TABELOM USER
